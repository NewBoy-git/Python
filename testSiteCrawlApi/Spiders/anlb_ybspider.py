...
#         tracks = self.get_tracks((distance + 14) * self.zoom)  # 对位移的缩放计算
#         print(tracks)
...
#                 print("登录失败")
#                 self.driver.quit()
#                 cookies_item['cookies_list'] = ''
#                 cookies_item['jscookies'] = ''
#                 cookies_item['code'] = 1
#                 with open('cookies.json','w',encoding='utf-8') as f:
#                     f.write(json.dumps(cookies_item))
#                 return cookies_item
...
#         driver.get('https://lb.ane56.com/apps/index.zul')
#         time.sleep(7)
#         button = etree.HTML(driver.page_source).xpath("//button[@class='z-button-os']/text()")
#         print(button)
#         if button != []:
#             driver.find_element_by_xpath("//button[@class='z-button-os']").send_keys(Keys.ENTER)
#             time.sleep(3)
#             sitename = etree.HTML(driver.page_source).xpath("//td[37]/span/text()")[0].strip("【 】")
#             driver.find_element_by_xpath("//div[@class='z-tree-body']//tr[3]").click()
#             time.sleep(1)
...
#             time.sleep(3)
#             yj_list = []
#             driver.find_element_by_xpath("//table[@class='z-tablelayout']//tr[2]/td[2]//input").send_keys(sitename)
#             driver.get_screenshot_as_file('web3.png')
#             for i in range(n, n + 3):
#                 yj_item = {}
#                 yj_item['date'] = datesta_list[i]
...
#                 try:
#                     yj_item['p_num'] = content.xpath("//tr[@valign='middle']/td[3]/span/text()")[0]
#                 except:
#                     yj_item['p_num'] = ''
#                 try:
#                     yj_item['j_num'] = content.xpath("//tr[@valign='middle']/td[7]/span/text()")[0]
#                 except:
#                     yj_item['j_num'] = ''
#                 try:
#                     yj_item['js_width'] = content.xpath("//tr[@valign='middle']/td[11]/span/text()")[0]
#                 except:
#                     yj_item['js_width'] = ''
#                 try:
#                     yj_item['sj_width'] = content.xpath("//tr[@valign='middle']/td[15]/span/text()")[0]
#                 except:
#                     yj_item['sj_width'] = ''
#                 try:
#                     yj_item['zz_width'] = content.xpath("//tr[@valign='middle']/td[19]/span/text()")[0]
#                 except:
#                     yj_item['zz_width'] = ''
#                 try:
#                     yj_item['tj_'] = content.xpath("//tr[@valign='middle']/td[23]/span/text()")[0]
#                 except:
#                     yj_item['tj_'] = ' '
#                 try:
#                     yj_item['dfk'] = content.xpath("//tr[@valign='middle']/td[27]/span/text()")[0]
#                 except:
#                     yj_item['dfk'] = ''
#                 try:
#                     yj_item['xj_'] = content.xpath("//tr[@valign='middle']/td[31]/span/text()")[1]
#                 except:
#                     yj_item['xj_'] = ''
#                 try:
#                     yj_item['yj'] = content.xpath("//tr[@valign='middle']/td[35]/span/text()")[1]
#                 except:
#                     yj_item['yj'] = ''
#                 try:
#                     yj_item['yf_hj'] = content.xpath("//tr[@valign='middle']/td[39]/span/text()")[0]
#                 except:
#                     yj_item['yf_hj'] = ''
#                 yj_list.append(yj_item)
#             # print(list_yw)
#             return yj_list
#         else:
#             driver.find_element_by_xpath("//div[@class='z-tree-body']//tr[4]").click()
...
#                 content = etree.HTML(driver.page_source)
#                 try:
#                     item_yj['p_num'] = content.xpath("//tr[@valign='middle']/td[3]/span/text()")[0]
#                 except:
#                     item_yj['p_num'] = ''
#                 try:
#                     item_yj['j_num'] = content.xpath("//tr[@valign='middle']/td[7]/span/text()")[0]
#                 except:
#                     item_yj['j_num'] = ''
#                 try:
#                     item_yj['js_width'] = content.xpath("//tr[@valign='middle']/td[11]/span/text()")[0]
#                 except:
#                     item_yj['js_width'] = ''
#                 try:
#                     item_yj['sj_width'] = content.xpath("//tr[@valign='middle']/td[15]/span/text()")[0]
#                 except:
#                     item_yj['sj_width'] = ''
#                 try:
#                     item_yj['zz_width'] = content.xpath("//tr[@valign='middle']/td[19]/span/text()")[0]
#                 except:
#                     item_yj['zz_width'] = ''
#                 try:
#                     item_yj['tj_'] = content.xpath("//tr[@valign='middle']/td[23]/span/text()")[0]
#                 except:
#                     item_yj['tj_'] = ' '
#                 try:
#                     item_yj['dfk'] = content.xpath("//tr[@valign='middle']/td[27]/span/text()")[0]
#                 except:
#                     item_yj['dfk'] = ''
#                 try:
#                     item_yj['xj_'] = content.xpath("//tr[@valign='middle']/td[31]/span/text()")[1]
#                 except:
#                     item_yj['xj_'] = ''
#                 try:
#                     item_yj['yj'] = content.xpath("//tr[@valign='middle']/td[35]/span/text()")[1]
#                 except:
#                     item_yj['yj'] = ''
#                 try:
#                     item_yj['yf_hj'] = content.xpath("//tr[@valign='middle']/td[39]/span/text()")[0]
#                 except:
#                     item_yj['yf_hj'] = ''
#                 yj_list.append(item_yj)
#             # print(list_yw)
#             return yj_list
#     except Exception as e:
#         print(e)
...
#             time.sleep(6)
#             list_yw = []
#             driver.get_screenshot_as_file('web9.png')
#             for i in range(n, n+3):
#                 yw_item = {}
#                 yw_item['date'] = datesta_list[i]
#                 driver.find_element_by_xpath("//td[2]//i[@class='required z-datebox']/input").clear()
#                 driver.find_element_by_xpath("//td[2]//i[@class='required z-datebox']/input").send_keys(datesta_list[i])
#                 driver.find_element_by_xpath("//td[3]/div/i[@class='required z-datebox']/input").clear()
#                 driver.find_element_by_xpath("//td[3]/div/i[@class='required z-datebox']/input").send_keys(
...
#                 content = etree.HTML(driver.page_source)
#                 try:
#                     yw_item['p_num'] = content.xpath("//tr[@valign='middle']/td[3]/span/text()")[0]
#                 except:
#                     yw_item['p_num'] = ''
#                 try:
#                     yw_item['j_num'] = content.xpath("//tr[@valign='middle']/td[7]/span/text()")[0]
#                 except:
#                     yw_item['j_num'] = ''
#                 try:
#                     yw_item['js_width'] = content.xpath("//tr[@valign='middle']/td[11]/span/text()")[0]
#                 except:
#                     yw_item['js_width'] = ''
#                 try:
#                     yw_item['sj_width'] = content.xpath("//tr[@valign='middle']/td[15]/span/text()")[0]
#                 except:
#                     yw_item['sj_width'] = ''
#                 try:
#                     yw_item['zz_width'] = content.xpath("//tr[@valign='middle']/td[19]/span/text()")[0]
#                 except:
#                     yw_item['zz_width'] = ''
#                 try:
#                     yw_item['tj_'] = content.xpath("//tr[@valign='middle']/td[23]/span/text()")[0]
#                 except:
#                     yw_item['tj_'] = ' '
#                 try:
#                     yw_item['dfk'] = content.xpath("//tr[@valign='middle']/td[27]/span/text()")[0]
#                 except:
#                     yw_item['dfk'] = ''
#                 try:
#                     yw_item['xj_'] = content.xpath("//tr[@valign='middle']/td[31]/span/text()")[1]
#                 except:
#                     yw_item['xj_'] = ''
#                 try:
#                     yw_item['yj'] = content.xpath("//tr[@valign='middle']/td[35]/span/text()")[1]
#                 except:
#                     yw_item['yj'] = ''
#                 try:
#                     yw_item['yf_hj'] = content.xpath("//tr[@valign='middle']/td[39]/span/text()")[0]
#                 except:
#                     yw_item['yf_hj'] = ''
#                 list_yw.append(yw_item)
#             # print(list_yw)
#             return list_yw
#         else:
#             "//*[text()='运单管理']"
...
#                 content = etree.HTML(driver.page_source)
#                 try:
#                     item_yw['p_num'] = content.xpath("//tr[@valign='middle']/td[3]/span/text()")[0]
#                 except:
#                     item_yw['p_num'] = ''
#                 try:
#                     item_yw['j_num'] = content.xpath("//tr[@valign='middle']/td[7]/span/text()")[0]
#                 except:
#                     item_yw['j_num'] = ''
#                 try:
#                     item_yw['js_width'] = content.xpath("//tr[@valign='middle']/td[11]/span/text()")[0]
#                 except:
#                     item_yw['js_width'] = ''
#                 try:
#                     item_yw['sj_width'] = content.xpath("//tr[@valign='middle']/td[15]/span/text()")[0]
#                 except:
#                     item_yw['sj_width'] = ''
#                 try:
#                     item_yw['zz_width'] = content.xpath("//tr[@valign='middle']/td[19]/span/text()")[0]
#                 except:
#                     item_yw['zz_width'] = ''
#                 try:
#                     item_yw['tj_'] = content.xpath("//tr[@valign='middle']/td[23]/span/text()")[0]
#                 except:
#                     item_yw['tj_'] = ' '
#                 try:
#                     item_yw['dfk'] = content.xpath("//tr[@valign='middle']/td[27]/span/text()")[0]
#                 except:
#                     item_yw['dfk'] = ''
#                 try:
#                     item_yw['xj_'] = content.xpath("//tr[@valign='middle']/td[31]/span/text()")[1]
#                 except:
#                     item_yw['xj_'] = ''
#                 try:
#                     item_yw['yj'] = content.xpath("//tr[@valign='middle']/td[35]/span/text()")[1]
#                 except:
#                     item_yw['yj'] = ''
#                 try:
#                     item_yw['yf_hj'] = content.xpath("//tr[@valign='middle']/td[39]/span/text()")[0]
#                 except:
#                     item_yw['yf_hj'] = ''
#                 list_yw.append(item_yw)
#             # print(list_yw)
#             return list_yw
#     except Exception as e:
#         print(e)
...
#                     "//tr[4]//td//div[@class='z-treecell-cnt z-overflow-hidden']/span[1]").click()
#                 time.sleep(3)
#                 driver.find_element_by_xpath("//table[@class='z-tablelayout'][1]//tr[2]/td[2]/div[1]/input").send_keys(
#                     sitename)
#                 time.sleep(3)
...
#     sta = time.time()
#     c = CrackSlider()
#     print(c.crack_slider('5563015','ane1112223.'))
#     end = time.time()
#     print(end-sta)
